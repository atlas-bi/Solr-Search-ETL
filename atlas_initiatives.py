...
, exec_owner.Fullname as exec_owner
...
left outer join app.User_NameData exec_owner on i.OperationOwnerID = exec_owner.UserId
...
left outer join app.User_NameData updater on updater.UserId = i.LastUpdateUser
"""
)
